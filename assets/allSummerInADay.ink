...
*   ->
    ...
    "Now, don't go too far," calls your teacher. "You've only two hours, you know. You wouldn't want to get caught out!"
    -> Play
...
* { not (HideAndSeek && Run) } [Rush into the jungle.]
-> Jungle

//conditional: only show this choice if the player hasn't chosen the other two already.
* { not (Jungle && Run) } [Play hide-and-seek.]
-> HideAndSeek

//conditional: only show this choice if the player hasn't chosen the other two already.
* { not (Jungle && HideAndSeek) } [Run and shout for joy.]
-> Run
